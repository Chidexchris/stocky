                                ...
                                @foreach($stores as $store)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('admin.stores.edit', $store->id) }}" class="btn btn-info btn-sm">
                                            ...
                                            <form id="destroy{{ $store->id }}" class="d-none" action="{{ route('admin.stores.destroy', $store->id) }}" method="POST">
                                                @csrf
                                                @method('delete')
                                            </form>
                                        </td>
